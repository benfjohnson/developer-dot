...
<div class="row">
	...
	<div class="col-xs-8">Administrative user should be able to view/modify:
		<ul>
	...
	to provide system ability to point to various levels of systems (Dev, UAT, Prod)</div>
</div>
<div class="row">
	<div class="col-xs-4">Validate Required Data in AvaTax Excise Call</div>
	<div class="col-xs-8">You should be able to identify the following values:
		<ul>
...
<div class="row">
	...
	<div class="col-xs-8">SaveTransactionInd field should not be set in integration code.  This can be tested by checking the Company Setting Value for Save Transaction Indicator within web interface:
		<ul>
...
<div class="row">
	...
	Process a Diesel Fuel transaction to Wisconsin with Destination Title Transfer where the buyer is licensed as a Indian Tribe</ddiv>
	<div class="col-xs-8">Confirm the following transaction:
		<ul>
...
Perspective Business Type– Buyer or Seller viewpoint (required for EU content).</div>
</div>
<div class="row">
<div class="col-xs-1">N</div>
<div class="col-xs-3">Send optional header level data elements:
<ul>
...
Debug Indicator - Indicates if the transaction should be calculated with debugging enabled.</div>
</div>
<div class="row">
<div class="col-xs-1">N</div>
<div class="col-xs-3">Send optional data elements for VAT:
<ul>
<li>Middleman</li>
...
Chain Leg – Indicates invoice position in a triangulation transaction in the EU</div>
</div>
<div class="row">
<div class="col-xs-1">N</div>
<div class="col-xs-3">Send optional Custom data elements:
<ul>
...
Custom Numeric - Decimal to hold data you want to pass into a transaction to be used for customizing calculations based on business rules.</div>
</div>
...
<div class="row">
<div class="col-xs-1">R</div>
<div class="col-xs-3">Send required data elements:
...
Invoice Line – Identifies the given transaction line to a pre-defined invoice line by the calling system</div>
</div>
<div class="row">
<div class="col-xs-1">N</div>
<div class="col-xs-3">Send optional data elements:
<ul>
...
Nth Time Sale - Integer to identify how many times a product has been sold in the supply chain.</div>
</div>
<div class="row">
<div class="col-xs-1">N</div>
<div class="col-xs-3">Send optional data elements for transaction Origin fields:
<ul>
...
Special Jurisdictions – Indicator if location belongs to a special jurisdiction</div>
</div>
<div class="row">
<div class="col-xs-1">N</div>
<div class="col-xs-3">Send optional data elements for transaction Sale fields:
<ul>
...
<div class="row">
<div class="col-xs-1">N</div>
<div class="col-xs-3">Send optional data elements for transaction Counter fields:
<ul>
...
Counter Fiscal Rep. Indicator – Y/N field to identify if a Counterparty Fiscal Rep is present in the Counterparty country.</div>
</div>
...
Field is requirement when completing a Transaction Line Measure record.</div>
</div>
...
Status Code - The calculation status of the tax.</div>
</div>
