...
jQuery( document ).ready(function() {
  jQuery( "#sample2radio" ).click(function() {
      ...
      jQuery("#widgetSample4").css("display","none");
     ...
     jQuery( "#sample4radio" ).click(function() {
      hidealloutputs();
      jQuery("#CWsampleTitle").text("Sample 4");
      jQuery("#widgetSample2").css("display","none");
      jQuery("#widgetSample1").css("display","none");
      jQuery("#widgetSample3").css("display","none");
      jQuery("#widgetSample4").fadeIn(800, function(){
        CWsampleToShow = 4;
        });      
   });
 ...
 // sample Output
      ...
      jQuery( "#revealSample" ).click(function() {
		...
		if(CWsampleToShow == 1){
		  ...
		  jQuery("#widgetOutput4").css("display","none");
		...
		if(CWsampleToShow == 4){
		  jQuery("#widgetsamplelabel").text("Sample 4 Output");
		  jQuery("#widgetOutput1").css("display","none");
		  jQuery("#widgetOutput2").css("display","none");
		  jQuery("#widgetOutput3").css("display","none");
		  jQuery("#widgetOutput4").fadeIn(800);      
		} 
